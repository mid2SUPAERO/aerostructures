# -*- coding: utf-8 -*-
"""
Created on Sat Sep 28 09:07:34 2019
...
class DynamicStructureProblemPureParams:

    def __init__(self, node_id_all, nastran_geometry):

        #List of all structural nodes
        self.node_id_all = node_id_all
        
        #Nastran initial geometry file
        self.nastran_geometry = nastran_geometry
